          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                A passionate video editor with 5+ years of experience crafting compelling visual stories
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              ...
              >
                <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100">
                  ...
                  <p className="text-gray-600 text-center leading-relaxed">
                    Transforming ideas into captivating visual experiences. Specializing in creative storytelling, 
                    color grading, and motion graphics that leave lasting impressions.
                  </p>
                </div>
              </motion.div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {skills.map((skill, index) => (
                  ...
                  >
                    <div className={`w-12 h-12 rounded-xl ${skill.color} flex items-center justify-center mb-3 shadow-lg`}>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {["Adobe Premiere Pro", "After Effects", "DaVinci Resolve", "Final Cut Pro", "Photoshop", "Illustrator"].map((tool, index) => (
                  <motion.div
                    key={index}
