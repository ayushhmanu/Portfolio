...
const steps = [
  {
    id: 1,
    title: "Discovery",
    description: "Understanding your vision, brand, and objectives to create the perfect video strategy.",
    icon: Lightbulb,
    color: "bg-red-600",
  },
  {
    ...
    description: "Planning shots, storyboarding, and organizing all the elements needed for success.",
    icon: Film,
    color: "bg-gray-800",
  },
  {
        ...
        <div className="w-full">
          ...
          <motion.div style={{ x }} className="flex px-6">
            {steps.map((step, index) => (
              <div
                key={step.id}
                className="flex-shrink-0 w-screen md:w-[50vw] px-6"
              >
                <motion.div
                ...
                >
                  <div className={`w-20 h-20 rounded-2xl ${step.color} flex items-center justify-center mb-8 shadow-xl`}>
                  ...
                  <h3 className="handwriting text-5xl text-gray-900 mb-6">
                    {step.title}
                  </h3>
