export const heroContent = {
    videoUrl: "https://res.cloudinary.com/dxyfsw8a0/video/upload/v1780983034/Showreel_fgfd8a.mp4",
    subtitle: " NOT JUST A ",
    title1: "VIDEO",
    title2: "EDITOR",
    description:
...
export const talentProfiles = [
    // Pattern ensures no two same logos are adjacent
...
export const footerContent = {
    title1: "LET'S CREATE",
    title2: "TOGETHER",
    email: "ayushhmanu.works@gmail.com",
    socialLinks: [
